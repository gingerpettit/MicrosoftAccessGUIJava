...
public class permissionsUpdatePanelBuilder extends JPanel{
	private JTextField nameTextField; 		// name

	public permissionsUpdatePanelBuilder() {
		...
		setBorder(BorderFactory.createTitledBorder("Enter Permissions Information"));
